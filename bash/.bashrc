...
alias magdisablemodules='php bin/magento module:disable Magento_TwoFactorAuth Magento_AdminAdobeImsTwoFactorAuth'
alias magrestart='composer install && magdisablemodules && magbuild && magscd'
